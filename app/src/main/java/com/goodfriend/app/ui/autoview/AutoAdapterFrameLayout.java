package com.goodfriend.app.ui.autoview;
...
public class AutoAdapterFrameLayout extends FrameLayout {
    ...
    public AutoAdapterFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
